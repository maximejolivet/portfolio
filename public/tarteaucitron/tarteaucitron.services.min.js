tarteaucitron.services.iframe = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['tac_iframe'], function (x) {
      ...
      var styleAttr =
        (width !== '' ? 'width:' + tarteaucitron.getStyleSize(width) + ';' : '') +
        (height !== '' ? 'height:' + tarteaucitron.getStyleSize(height) + ';' : '')
      return (
        '<iframe title="' +
        frame_title +
        '" src="' +
...
tarteaucitron.services.teambrain = {
  ...
  js: function () {
    'use strict'
    if (
      tarteaucitron.user.teambrainUrl === undefined ||
      tarteaucitron.user.teambrainProxyUrl === undefined
    ) {
      return
    }
    tarteaucitron.addScript(
      tarteaucitron.user.teambrainUrl,
      'tb-ext-app',
      '',
      '',
      'data-proxy-url',
      tarteaucitron.user.teambrainProxyUrl,
    )
  },
}
tarteaucitron.services.usercom = {
  ...
  js: function () {
    ...
    window.civchat = { apiKey: tarteaucitron.user.userApiKey }
...
tarteaucitron.services.cjcom = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://www.mczbf.com/tags/' + tarteaucitron.user.cjUserId + '/tag.js',
      'cjapitag',
    )
  },
}
tarteaucitron.services.clickdimensions = {
  ...
  js: function () {
    'use strict'
    if (
      tarteaucitron.user.clickdimensionsAccountKey === undefined ||
      tarteaucitron.user.clickdimensionsDomain === undefined
    ) {
      return
    }
...
tarteaucitron.services.kompass = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://fr.kompass.com/leads/script.js?id=' + tarteaucitron.user.kompassId,
    )
  },
}
...
tarteaucitron.services.markerio = {
  ...
  js: function () {
    ...
    window.markerConfig = { project: tarteaucitron.user.markerioProjectId, source: 'snippet' }
    !(function (e, r, a) {
      if (!e.__Marker) {
        e.__Marker = {}
        var t = [],
...
tarteaucitron.services.gcmadsuserdata = {
  ...
  fallback: function () {
    'use strict'
    if (tarteaucitron.parameters.googleConsentMode === true) {
      window.tac_gtag('consent', 'update', { ad_user_data: 'denied', ad_personalization: 'denied' })
    }
  },
}
tarteaucitron.services.gcmpersonalization = {
  ...
  js: function () {
    'use strict'
    if (tarteaucitron.parameters.googleConsentMode === true) {
      window.tac_gtag('consent', 'update', { personalization_storage: 'granted' })
    }
  },
  fallback: function () {
    'use strict'
    if (tarteaucitron.parameters.googleConsentMode === true) {
      window.tac_gtag('consent', 'update', { personalization_storage: 'denied' })
    }
  },
}
    ...
    window['$screeb'] =
      ...
      function () {
        ...
        return new Promise(function (a, b) {
          ;(window['$screeb'].q = window['$screeb'].q || []).push({ v: 1, args: d, ok: a, ko: b })
        })
      }
...
tarteaucitron.services.shinystat = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://codice.shinystat.com/cgi-bin/getcod.cgi?USER=' + tarteaucitron.user.shinystatUser,
    )
  },
}
...
tarteaucitron.services.leadforensics = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://secure.team8save.com/js/sc/' + tarteaucitron.user.leadforensicsId + '.js',
    )
  },
}
...
tarteaucitron.services.myfeelback = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://actorssl-5637.kxcdn.com/actor/' + tarteaucitron.user.myfeelbackId + '/action',
      'MFBActor',
    )
  },
}
...
tarteaucitron.services.sharpspring = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://' + tarteaucitron.user.ssId + '.marketingautomation.services/client/ss.js',
    )
  },
}
...
tarteaucitron.services.xandrsegment = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'add=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentAdd') +
        '&'
      uri +=
        'add_code=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentAddCode') +
        '&'
      uri +=
        'remove=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentRemove') +
        '&'
      uri +=
        'remove_code=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentRemoveCode') +
        '&'
      uri +=
        'member=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentMember') +
        '&'
      uri +=
        'redir=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentRedir') +
        '&'
      uri +=
        'value=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentValue') +
        '&'
      uri +=
        'other=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrsegmentOther')
...
tarteaucitron.services.xandrconversion = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'id=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionId') +
        '&'
      uri +=
        'seg=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionSeg') +
        '&'
      uri +=
        'order_id=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionOrderId') +
        '&'
      uri +=
        'value=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionValue') +
        '&'
      uri +=
        'redir=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionRedir') +
        '&'
      uri +=
        'other=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'xandrconversionOther')
      document.getElementById(uniqIds[i]).innerHTML =
        "<img src='" + uri + "' width='1' height='1' />"
    }
  },
...
tarteaucitron.services.addthis = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//s7.addthis.com/js/300/addthis_widget.js#pubid=' + tarteaucitron.user.addthisPubId,
    )
  },
  fallback: function () {
    'use strict'
  ...
  js: function () {
    ...
    for (var i = 0; i < elements.length; i++) {
      ...
      if (tarteaucitron.getElemAttr(element, 'itemNumber')) {
        url +=
          '&item_number=' + encodeURIComponent(tarteaucitron.getElemAttr(element, 'itemNumber'))
      }
      if (tarteaucitron.getElemAttr(element, 'description')) {
        url +=
          '&description=' + encodeURIComponent(tarteaucitron.getElemAttr(element, 'description'))
      }
      new Image().src = url
    }
  },
    ...
    window.AdUpRetargeting = function (api) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (tarteaucitron.getElemAttr(element, 'device')) {
          var setter =
            'set' +
            tarteaucitron.getElemAttr(element, 'device').charAt(0).toUpperCase() +
        ...
        if (tarteaucitron.getElemAttr(element, 'track')) {
          var tracker =
            'track' +
            tarteaucitron.getElemAttr(element, 'track').charAt(0).toUpperCase() +
...
tarteaucitron.services.criteo = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['criteo-canvas'], function (x) {
      ...
      uniqIds.push(uniqId)
      return (
        '<div id="' + uniqId + '" zoneid="' + tarteaucitron.getElemAttr(x, 'zoneid') + '"></div>'
      )
    })
    for (i = 0; i < uniqIds.length; i += 1) {
...
tarteaucitron.services.criteoonetag = {
  ...
  js: function () {
    ...
    window.criteo_q.push({ event: 'setAccount', account: tarteaucitron.user.criteoonetagAccount })
...
tarteaucitron.services.datingaffiliationpopup = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'comfrom=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'comfrom') + '&'
      uri +=
        'promo=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'promo') + '&'
      uri +=
        'product_id=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'productid') +
        '&'
      uri +=
        'submitconfig=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'submitconfig') +
        '&'
      uri += 'ur=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'ur') + '&'
      uri +=
        'brand=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'brand') + '&'
      ...
      uri +=
        'subid1=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'subid1') + '&'
      uri +=
        'cfsa2=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'cfsa2') + '&'
      uri +=
        'subid2=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'subid2') + '&'
      uri +=
        'nicheId=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'nicheid') + '&'
      uri +=
        'degreId=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'degreid') + '&'
...
tarteaucitron.services.leadforensicsold = {
  ...
  js: function () {
    ...
    ;(function () {
      ...
      sf14g.async = true
      sf14g.src =
        ('https:' == document.location.protocol ? 'https://' : 'http://') + 't.sf14g.com/sf14g.js'
      var s = document.getElementsByTagName('script')[0]
      s.parentNode.insertBefore(sf14g, s)
    })()
    tarteaucitron.addScript(
      '//secure.leadforensics.com/js/' + tarteaucitron.user.leadforensicsIidentifier + '.js',
    )
  },
}
...
tarteaucitron.services.ekomi = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//connect.ekomi.de/integration_1410173009/' + tarteaucitron.user.ekomiCertId + '.js',
    )
  },
}
...
tarteaucitron.services.adsensesearchform = {
  ...
  js: function () {
    'use strict'
    tarteaucitron.addScript(
      '//www.google.com/coop/cse/brand?form=cse-search-box&lang=' + tarteaucitron.getLanguage(),
    )
  },
}
tarteaucitron.services.adsensesearchresult = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//www.google.com/cse/cse.js?cx=' + tarteaucitron.user.adsensesearchresultCx,
    )
  },
  fallback: function () {
    'use strict'
...
tarteaucitron.services.analytics = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript('https://www.google-analytics.com/analytics.js', '', function () {
      var uaCreate = { cookieExpires: timeExpire !== undefined ? timeExpire : 34128e3 }
...
tarteaucitron.services.googleads = {
  ...
  js: function () {
    ...
    if (
      tarteaucitron.user.googleadsCustomDomain !== undefined &&
      tarteaucitron.user.googleadsCustomDomain !== ''
    ) {
      customDomain = tarteaucitron.user.googleadsCustomDomain
    }
    window.dataLayer = window.dataLayer || []
    tarteaucitron.addScript(
      'https://' + customDomain + '/gtag/js?id=' + tarteaucitron.user.googleadsId,
      '',
      function () {
...
tarteaucitron.services.gtag = {
  ...
  js: function () {
    ...
    var customDomain = 'www.googletagmanager.com'
    if (
      tarteaucitron.user.gtagCustomDomain !== undefined &&
      tarteaucitron.user.gtagCustomDomain !== ''
    ) {
      customDomain = tarteaucitron.user.gtagCustomDomain
    }
    window.dataLayer = window.dataLayer || []
    tarteaucitron.addScript(
      'https://' + customDomain + '/gtag/js?id=' + tarteaucitron.user.gtagUa,
      '',
      function () {
        window.gtag = function gtag() {
          dataLayer.push(arguments)
...
tarteaucitron.services.googlemaps = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://maps.googleapis.com/maps/api/js?loading=async&v=3.exp&key=' +
    ...
    window.tac_googlemaps_callback = function () {
      ...
      for (i = 0; i < uniqIds.length; i += 1) {
        mapOptions = {
          zoom: parseInt(
            tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'zoom'),
            10,
          ),
          center: new google.maps.LatLng(
            parseFloat(
              tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'latitude'),
              10,
            ),
            parseFloat(
              tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'longitude'),
              10,
            ),
          ),
        }
...
tarteaucitron.services.googletagmanager = {
  ...
  js: function () {
    ...
    var customDomain = 'www.googletagmanager.com'
    if (
      tarteaucitron.user.googletagmanagerCustomDomain !== undefined &&
      tarteaucitron.user.googletagmanagerCustomDomain !== ''
    ) {
      customDomain = tarteaucitron.user.googletagmanagerCustomDomain
    }
    tarteaucitron.addScript(
      'https://' + customDomain + '/gtm.js?id=' + tarteaucitron.user.googletagmanagerId,
    )
  },
  fallback: function () {
    if (tarteaucitron.parameters.googleConsentMode === true) {
...
tarteaucitron.services.multiplegoogletagmanager = {
  ...
  js: function () {
    ...
    var customDomain = 'www.googletagmanager.com'
    if (
      tarteaucitron.user.multiplegoogletagmanagerCustomDomain !== undefined &&
      tarteaucitron.user.multiplegoogletagmanagerCustomDomain !== ''
    ) {
...
tarteaucitron.services.hubspot = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//js.hs-scripts.com/' + tarteaucitron.user.hubspotId + '.js' + tac_businessUnitId,
      'hs-script-loader',
    )
  },
}
...
tarteaucitron.services.prelinker = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'site_id=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'siteId') + '&'
      uri +=
        'banner_id=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'bannerId') +
        '&'
      uri +=
        'default_language=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'defaultLanguage') +
        '&'
...
tarteaucitron.services.shareasale = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'amount=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'amount') + '&'
      uri +=
        'tracking=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'tracking') +
        '&'
      uri +=
        'transtype=' +
        tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'transtype') +
        '&'
      uri +=
        'persale=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'persale') + '&'
      uri +=
        'perlead=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'perlead') + '&'
      uri +=
        'perhit=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'perhit') + '&'
      uri +=
        'merchantID=' + tarteaucitron.getElemAttr(document.getElementById(uniqIds[i]), 'merchantID')
      document.getElementById(uniqIds[i]).innerHTML =
        "<img src='" + uri + "' width='1' height='1' />"
    }
  },
...
tarteaucitron.services.tagcommander = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://cdn.tagcommander.com/' + tarteaucitron.user.tagcommanderid + '.js',
    )
  },
}
...
tarteaucitron.services.multiplegtag = {
  ...
  js: function () {
    ...
    var customDomain = 'www.googletagmanager.com'
    if (
      tarteaucitron.user.multiplegtagCustomDomain !== undefined &&
      tarteaucitron.user.multiplegtagCustomDomain !== ''
    ) {
...
tarteaucitron.services.hotjar = {
  ...
  js: function () {
    ...
    window._hjSettings = { hjid: tarteaucitron.user.hotjarId, hjsv: tarteaucitron.user.HotjarSv }
...
tarteaucitron.services.userlike = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//userlike-cdn-widgets.s3-eu-west-1.amazonaws.com/' + tarteaucitron.user.userlikeKey,
    )
  },
}
tarteaucitron.services.adobeanalytics = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//assets.adobedtm.com/launch-' + tarteaucitron.user.adobeanalyticskey + '.min.js',
    )
  },
}
...
tarteaucitron.services.visiblee = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//www.link-page.info/tracking_' + tarteaucitron.user.visibleeclientid + '.js',
      'visiblee',
    )
  },
}
...
tarteaucitron.services.goptimize = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://www.googleoptimize.com/optimize.js?id=' + tarteaucitron.user.goptimize,
    )
  },
}
...
tarteaucitron.services.studizz = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://webchat.studizz.fr/webchat.js?token=' + tarteaucitron.user.studizzToken,
    )
  },
}
...
tarteaucitron.services.gallica = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['gallica_player'], function (x) {
      ...
      frame =
        '<iframe title="' + frame_title + '" style="' + style + '" src="' + src + '"></iframe>'
      return frame
    })
  },
  fallback: function () {
...
tarteaucitron.services.facebookcustomerchat = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://connect.facebook.net/' + tarteaucitron.getLocale() + '/sdk/xfbml.customerchat.js',
      'facebook-jssdk',
    )
  },
  fallback: function () {
...
tarteaucitron.services.klaviyo = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      '//static.klaviyo.com/onsite/js/klaviyo.js?company_id=' + tarteaucitron.user.klaviyoCompanyId,
    )
  },
}
