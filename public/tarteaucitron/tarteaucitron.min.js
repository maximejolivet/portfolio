...
var tarteaucitron = {
  ...
  load: function () {
    ...
    if (tarteaucitron.parameters.pianoConsentMode === true) {
      ...
      if (tarteaucitron.parameters.pianoConsentModeEssential === true) {
        window.pdl.consent = { products: ['PA'], defaultPreset: { PA: 'essential' } }
      } else {
        window.pdl.consent = { products: ['PA'], defaultPreset: { PA: 'opt-out' } }
      }
      document.addEventListener(
        'pianoanalytics_consentModeOk',
        function () {
          window.pdl.consent = { products: ['PA'], defaultPreset: { PA: 'opt-in' } }
      ...
      tarteaucitron.addInternalScript(pathToServices, '', function () {
        ...
        if (tarteaucitron.parameters.mandatory == true) {
          ...
          if (tarteaucitron.parameters.showDetailsOnClick) {
            ...
            html +=
              '   <span class="asCatToggleBtn">' + tarteaucitron.lang.mandatoryTitle + '</span>'
          }
          html += '</div>'
        ...
        if (
          ...
          setTimeout(function () {
            tarteaucitron.addClickEventToId('tarteaucitron-toggle-group-cookies', function () {
              ...
              if (
                document.getElementById('tarteaucitronServices_cookies').style.display == 'block'
              ) {
        ...
        if (tarteaucitron.parameters.showAlertSmall === true) {
          html +=
            '<div id="tarteaucitronAlertSmall" class="tarteaucitronAlertSmall' + orientation + '">'
          html +=
            '   <button type="button" id="tarteaucitronManager" aria-label="' +
          ...
          Array.prototype.forEach.call(cats, function (item) {
            ...
            if (cat !== 'mandatory') {
              ...
              tarteaucitron.addClickEventToId('tarteaucitron-toggle-group-' + cat, function () {
                ...
                if (
                  document.getElementById('tarteaucitronServices_' + cat).style.display == 'block'
                ) {
                  tarteaucitron.userInterface.addClass(
  ...
  addService: function (serviceId) {
    ...
    var cookie = tarteaucitron.cookie.read(),
      ...
      isNavigating =
        hostRef === hostname && window.location.href !== tarteaucitron.parameters.privacyUrl,
      ...
      isResponded =
        cookie.indexOf(service.key + '=false') >= 0 || cookie.indexOf(service.key + '=true') >= 0,
      isDNTRequested =
  ...
  cookie: {
    ...
    create: function (key, status) {
      ...
      document.cookie =
        value + '; expires=' + d.toGMTString() + '; path=/' + domain + secure + '; samesite=lax'
    ...
    purge: function (arr) {
      'use strict'
      var i, j, k, service, allowed, rgxpCookie
      for (i = 0; i < arr.length; i += 1) {
        allowed = false
        if (
          tarteaucitron.parameters.cookieslist !== true &&
          tarteaucitron.parameters.cookieslistEmbed !== true
        ) {
    ...
    number: function () {
      ...
      cookies = cookies.sort(function (a, b) {
        ...
        c =
          tarteaucitron.cookie.owner[namea] !== undefined ? tarteaucitron.cookie.owner[namea] : '0'
        d =
          tarteaucitron.cookie.owner[nameb] !== undefined ? tarteaucitron.cookie.owner[nameb] : '0'
        if (c + a > d + b) {
          return 1
        }
        if (c + a < d + b) {
      ...
      if (document.cookie !== '') {
        for (i = 0; i < nb; i += 1) {
          ...
          html +=
            ...
            tarteaucitron.cookie.beautify(cookies[i].split('=').slice(1).join('=')) +
            '</div>'
          html += '</li>'
        }
        html += '</ul>'
  ...
  getLanguage: function () {
    ...
    if (
      ...
      if (
        availableLanguages.indexOf(document.documentElement.getAttribute('lang').substr(0, 2)) !==
        -1
      ) {
  ...
  makeAsync: {
    ...
    execJS: function (id) {
      ...
      for (i = 0; i < scripts.length; i += 1) {
        ...
        if (type === '') {
          type =
            scripts[i].getAttribute('language') !== null ? scripts[i].getAttribute('language') : ''
        }
  ...
  dynamicJobPush: function (id) {
    if (tarteaucitron.added[id] !== true) {
      ...
      if (
        (typeof tarteaucitronMagic === 'undefined' ||
          tarteaucitronMagic.indexOf('_' + id + '_') < 0) &&
        tarteaucitron.parameters.serverSide !== true
      ) {
        if (
          tarteaucitron.state[id] === true &&
          typeof tarteaucitron.services[id].js === 'function'
        ) {
