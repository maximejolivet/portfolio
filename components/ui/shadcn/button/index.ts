...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap rounded-md ' +
    ...
    'focus-visible:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 ' +
    'aria-invalid:border-destructive',
  {
    variants: {
      variant: {
        ...
        pill:
          'rounded-full bg-primary font-sans font-semibold text-primary-foreground ' +
          'hover:bg-accent hover:text-background',
        'pill-outline':
          'rounded-full border border-border bg-transparent font-mono font-semibold ' +
      ...
      size: {
        ...
        'pill-sm': 'h-auto px-3.5 py-1.5 text-[0.6563rem]',
      },
    },
    defaultVariants: {
      variant: 'default',
