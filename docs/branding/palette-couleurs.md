...
| Info        | `--color-info`    | `#8AB4EF` _(à créer, cousin bleu du gold)_ | Messages informatifs     |
...
| Info          | `--color-info`     | `#8AB4EF` _(to create, blue cousin of gold)_ | Informational messages   |
