...
>
    ...
    <button
type="button"
      class="fixed bottom-38 right-6 z-50 flex items-center gap-1.5 rounded-full border border-border bg-background/90 px-3.5 py-2 font-mono text-xs font-semibold text-muted-foreground shadow-md backdrop-blur-sm transition-colors hover:text-accent"
